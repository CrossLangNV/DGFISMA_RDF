...
import tests.reporting_obligations.build_rdf_example
...
class TestExample(unittest.TestCase):
    def test_NUM_RO(self):
        cas_content = tests.reporting_obligations.build_rdf_example.ExampleCasContent.build()
...
class TestCasContent(unittest.TestCase):
    def test_return(self):
        l = [{KEY_CHILDREN: [{KEY_VALUE: "v", KEY_SENTENCE_FRAG_CLASS: "g"}], KEY_VALUE: "full v."}]
