...
class TestLocalGraph(unittest.TestCase):
    def setUp(self) -> None:
        ...
        g.add_cas_content(cas_content, doc_id=doc_id)

        # Some extra data
        doc_id2 = "https://example.com/doc2"
        g.add_cas_content(cas_content, doc_id=doc_id2)
    ...
    def test_filter(self):
        ...
        with self.subTest("Drop down elements"):
            ...
            r_doc_src = self.prov.get_filter_entities_from_type_lazy_loading(l_ent_type_i, doc_src=self.source_id)
...
class TestRemoteGraph(unittest.TestCase):
    ...
    def test_filter(self):
        ...
        with self.subTest("Drop down elements"):
            ...
            r_doc_src = self.prov.get_filter_entities_from_type_lazy_loading(l_ent_type_i, doc_src=source_id)
